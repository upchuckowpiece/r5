...
const UUIDS = [
'29d6e9f0-9511-46a9-96ab-2ae95fdebf91',
'10836b7e-7ca5-4a0b-a266-775ea004ab60',
'435e0e83-0d3e-4537-b197-db16b97105fc',
];

// 订阅地址后缀（这里需要修改一下，可以随便输入一些字母或数字）
const SUB_PATH = 'FLPp48dpcdfv';

// XHTTP 路径（这里需要修改一下，可以随便输入一些字母或数字）
const XPATH = 'tzSs10TwcK5LT';
